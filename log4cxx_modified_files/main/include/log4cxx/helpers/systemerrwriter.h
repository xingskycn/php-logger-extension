...
namespace log4cxx
{
        namespace helpers {
          ...
          */
          ...
          private:
                  static LogString lastMessage;  // store last messages send to stderr
				  static char* lastMessageAscii; // used to return lastMessage as char *

				  static void storeLastMessage(const LogString& str);
